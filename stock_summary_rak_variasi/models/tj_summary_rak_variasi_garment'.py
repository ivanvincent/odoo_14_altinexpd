...
class TjSummaryRakVariasi(models.Model):
    ...
    def action_calculate(self):
        ...
        query = """
                ...
                union
                select c.id,c.product_id,c.product_uom,0 as saldo_awal_qty,0 as saldo_awal_pcs, 0 as terima_qty,0 as terima_pcs, 0 as retur_terima_qty, 0 as retur_terima_pcs, c.product_uom_qty as keluar_qty, 1 as keluar_pcs, 0 as retur_keluar_qty, 0 as retur_keluar_pcs, 0 as adj_qty, 0 as adj_pcs  from stock_picking a , stock_move c where a.scheduled_date > '%s' and a.scheduled_date < '%s'  and  a.id=c.picking_id and a.location_id=%s and a.state='done'
                union
                ...
                union
                select b.id,b.product_id,b.product_uom,0 as saldo_awal_qty,0 as saldo_awal_pcs, 0 as terima_qty,0 as terima_pcs, 0 as retur_terima_qty, 0 as retur_terima_pcs, b.product_uom_qty as keluar_qty, 1 as keluar_pcs, 0 as retur_keluar_qty, 0 as retur_keluar_pcs, 0 as adj_qty, 0 as adj_pcs  from stock_picking a left join stock_move b on a.id=b.picking_id  where a.scheduled_date >= '%s' and a.scheduled_date < '%s'  and a.location_id=%s and a.state='done'
                union
