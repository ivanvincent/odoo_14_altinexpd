...
def add_workbook_format(workbook):
    ...
    wbf['foot_center'] = workbook.add_format({'align': 'center', 'border': 1, 'bold': 1,})

    wbf['content_float'] = workbook.add_format({'align': 'left', 'num_format': '#,##0.00'})
    ...
    wbf['merge_format_2'] = workbook.add_format({'bold': 1,   'border': 1, 'align': 'left'})
