odoo.define("ks_curved_backend_theme.KsListDocumentViewer", function (require) {
  ...
  var KsListDocumentViewer = Widget.extend({
    ...
    events: {
      ...
      "DOMMouseScroll .o_viewer_content": "ksOnScrollPreview", // Scroll for Firefox browser.
      "mousewheel .o_viewer_content": "ksOnScrollPreview", // Scroll for Chrome, Safari, IE browser.
      keyup: "ksOnKeyUp",
    },
