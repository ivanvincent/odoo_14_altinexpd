...
class MrpBom(models.Model):
    ...
    # color_id = fields.Many2one('product.attribute.value', related='product_id.color_id', string="Color")
            ...
            if not bom.bom_line_ids:
                ...
                for first_comp in bom.mrp_first_compenent_ids:
                    ...
                    data.append((0, 0, {
                        ...
                        'product_qty' : first_comp.quantity,
    ...
    def action_get_material_td(self,location_id = None,volume_air = None):
        ...
        if td_id:
            ...
            for td in td_id.final_ids:
                if td.workcenter_id.name in ['FINISH', 'FINAL SETT']:
                    for chem in td.chemical_ids.filtered(lambda x: x.type == 'finish'):
                        data.append((0, 0, {
