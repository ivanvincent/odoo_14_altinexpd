...
class MrpReportBomStructureInherit(models.AbstractModel):
    _name = "report.mrp_request.report_bom_structure"
    _inherit = "report.mrp.report_bom_structure"


    def _get_bom(self, bom_id=False, product_id=False, line_qty=False, line_id=False, level=False):
        res = super(MrpReportBomStructureInherit, self)._get_bom(bom_id, product_id, line_qty, line_id, level)
