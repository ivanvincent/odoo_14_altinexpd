...
class ResConfigSettings(models.TransientModel):
    ...
    def remove_simpanan(self):
        to_removes = [
            # 清除生产BOM
            'simpanan.bunga.detail',
            'simpanan.bunga',
            'simpanan.details',
            'simpanan',
        ]
    ...
    def remove_pinjaman(self):
        to_removes = [
            # 清除生产BOM
            'pinjaman.tunggakan.detail',
            'pinjaman.tunggakan',
            'pinjaman.pelunasan.detail',
            'pinjaman.pelunasan',
            'pinjaman.details',
            'pinjaman',
        ]
    ...
    def remove_shu_transaksi(self):
        to_removes = [
            # 清除生产BOM
            'shu.transaksi.detail',
            'shu.transaksi',
        ]
        seqs = []
        return self.remove_app_data(to_removes, seqs)

    def remove_master_simpanan(self):
        to_removes = [
            # 清除生产BOM
            'simpanan.bunga.detail',
            'simpanan.bunga',
            ...
            'simpanan',
            'master.simpanan',
            'master.simpanan.type',
        ]
        seqs = []
        return self.remove_app_data(to_removes, seqs)

    def remove_master_pinjaman(self):
        to_removes = [
            # 清除生产BOM
            'pinjaman.tunggakan.detail',
            'pinjaman.tunggakan',
            ...
            'pinjaman.details',
            'pinjaman',
            'master.pinjaman.pelunasan.detail',
            'master.pinjaman.pelunasan',
            'master.pinjaman',
            'master.pinjaman.type',
