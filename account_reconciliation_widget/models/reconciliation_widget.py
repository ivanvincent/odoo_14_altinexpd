...
class AccountReconciliation(models.AbstractModel):
    ...
    def _str_domain_for_mv_line(self, search_str):
        return [
            ...
            "|",
            ("move_id.kontrabon_id.name", "ilike", search_str),
            "|",
    ...
    def _prepare_move_lines(
        ...
        for line in move_lines:
            ...
            kontrabon = line.move_id.kontrabon_id.name
            ret_line["kontrabon_number"] = kontrabon if kontrabon else ""
            ret.append(ret_line)
        return ret
    ...
    def _get_statement_line(self, st_line):
        ...
        data = {
            ...
            "invoice_id":st_line.invoice_id.id,
            "account_id": [
                st_line.journal_id.default_account_id.id,
