...
class SendProductionWizard(models.TransientModel):
    _name = 'send.production.wizard.new'
    
    line_ids = fields.One2many('detail.specification.mo.new', 'wizard_id', string='Detail')
...
class DetailSpecificationMo(models.TransientModel):
    _name = 'detail.specification.mo.new'

    wizard_id = fields.Many2one('send.production.wizard.new', string="wizard")
    ...
    qrf_line_id = fields.Many2one('quotation.request.form.line.new', string="QRF Line")