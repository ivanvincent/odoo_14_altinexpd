...
class LapPenerimaanKainGreigeWizard(models.TransientModel):
    _name = 'lap_penerimaan_kain_greige.wizard'
    ...
    def action_generate(self):
        ...
        where_location = " 1=1 "
        if self.location_id :
            where_location = " sp.location_dest_id = %s "%self.location_id.id
        ...
        query = """
            ...
            from (
                ...
                where
                    ...
                    sp.picking_type_id in (select id from stock_picking_type where code = 'incoming') and
                    """+ where_location +""" and
                    mg.name <> 'X'
                group by 
        ...
        return self.env.ref('reporting.action_lap_penerimaan_kain_greige_wizard').report_action(None, data=data)


class LapPenerimaanKainGreigeAbstract(models.AbstractModel):
    _name = 'report.reporting.lap_penerimaan_kain_greige_wizard'
