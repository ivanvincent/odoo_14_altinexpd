odoo.define('wibicon_mo_scanner.models', function (require) {
    "use strict";
    
    const { Context } = owl;
    var ScannerDB = require('wibicon_mo_scanner.scannerDB');
    ...
    exports.ScannerModel = Backbone.Model.extend({
        initialize: function(attributes) {
            ...
            this.db = new ScannerDB();                       // a local database used to search trough products and categories & store pending orders
        ...
        // releases ressources holds by the model at the end of life of the Scannermodel
        destroy: function(){
    ...
    exports.register_payment_method = function(use_payment_terminal, ImplementedPaymentInterface) {
        exports.ScannerModel.prototype.electronic_payment_interfaces[use_payment_terminal] = ImplementedPaymentInterface;
    };
    ...
    exports.load_fields = function(model_name, fields) {
        ...
        var models = exports.ScannerModel.prototype.models;
    ...
    //   value. The function takes the ScannerModel as the first argument
    ...
    exports.load_models = function(models,options) {
        ...
        var pmodels = exports.ScannerModel.prototype.models;
