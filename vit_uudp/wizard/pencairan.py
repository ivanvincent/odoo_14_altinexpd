...
class pencairanWizard(models.TransientModel):
	...
	def action_pencairan(self):
		...
		for line in self.uudp_pencairan_id.ajuan_id.uudp_ids:
			...
			bank_cash_line_ids += [(0,0,{"date":self.date,"partner_id":self.uudp_pencairan_id.ajuan_id.responsible_id.partner_id.id,'employee_id':self.uudp_pencairan_id.ajuan_id.employee_id.id,"payment_ref":label_credit,"credit":line.total})]
