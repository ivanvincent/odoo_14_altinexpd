...
class uudpPencairan(models.Model):
    ...
    coa_kredit = fields.Many2one("account.account", string="Account", related="journal_id.payment_credit_account_id", help="Credit Account", track_visibility='onchange')
    ...
    def _onchange_journal(self):
        res = {}
        payment_type = 'bank' if self.cara_bayar == 'transfer' else 'cash'
