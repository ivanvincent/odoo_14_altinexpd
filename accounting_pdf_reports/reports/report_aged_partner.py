...
class ReportAgedPartnerBalance(models.AbstractModel):
    ...
    def _get_partner_move_lines(self, account_type, date_from, target_move, period_length):
        ...
        query = '''
            SELECT DISTINCT l.partner_id, l.group_partner_id, UPPER(res_partner.name)
            ...
            ORDER BY l.group_partner_id,UPPER(res_partner.name)'''
        ...
        for partner in partners:
            ...
            if partner['partner_id']:
                ...
                values['group_company'] = browsed_partner.group_partner_id.name
            else:
