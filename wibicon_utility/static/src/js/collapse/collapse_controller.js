odoo.define('wibicon_utility.CollapseController', function (require) {
    "use strict";
var AbstractController = require('web.AbstractController');
var core = require('web.core');
var dialogs = require('web.view_dialogs');
// var BasicController = require('web.BasicController');
var CollapseController = AbstractController.extend({
    custom_events: _.extend({}, AbstractController.prototype.custom_events, {
        // collapse_data_updated: '_onGanttUpdated',
        // collapse_create_dp: '_onCreateDataProcessor',
        // collapse_config: '_onConfig',
        // collapse_show_critical_path: '_onShowCriticalPath',
        // collapse_schedule: '_onSchedule',
    }),
    date_object: new Date(),
    init: function (parent, model, renderer, params) {
        // console.log('controller init');
        this._super.apply(this, arguments);
        this.Model = 'purchase.order';  // todo: read from view arch
    },
    _onCreateDataProcessor: function(event){
        ...
        //     switch (action) {
        //         case "update":
        //             // return self.trigger_up('collapse_data_updated', {entity, data});
        //             switch(entity){
        //                 case "task":
    ...
    _onConfig: function(){
        var self = this;
        if(this.collapse_configured){
            return;
        }
        this.collapse_configured = true;
        ...
        //     var modelName = task.isProject && self.Model || self.model.modelName;
