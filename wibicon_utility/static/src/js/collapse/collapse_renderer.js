odoo.define('wibicon_utility.CollapseRenderer', function (require) {
    "use strict";

    var AbstractRenderer = require('web.AbstractRenderer');

    var CollapseRenderer = AbstractRenderer.extend({
        template: "wibicon_utility.collapse_view",
        ...
        init: function (parent, state, params) {
            console.log('init CollapseRenderer');
