odoo.define('wibicon_utility.ListWibiconConfirmDialog', function (require) {
"use strict";
 ...
 * @class
 */
const ListWibiconConfirmDialog = Dialog.extend(WidgetAdapterMixin, {
    /**
     * @constructor
     * @override
     * @param {Widget} parent
...
return ListWibiconConfirmDialog;
