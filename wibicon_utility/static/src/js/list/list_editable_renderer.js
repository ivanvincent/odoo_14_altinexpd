odoo.define('wibicon_utility.EditableWibiconListWibiconRenderer', function (require) {
"use strict";
 ...
 * file simply 'includes' the basic ListWibiconRenderer to add all the necessary
...
ListWibiconRenderer.include({
    RESIZE_DELAY: 200,
    custom_events: _.extend({}, ListWibiconRenderer.prototype.custom_events, {
        navigation_move: '_onNavigationMove',
    }),
    events: _.extend({}, ListWibiconRenderer.prototype.events, {
    ...
    _getColumnWidth: function (column) {
        ...
        const fieldsInfo = this.state.fieldsInfo.wibiconlist;
