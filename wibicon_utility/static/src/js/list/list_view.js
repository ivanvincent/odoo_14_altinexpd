odoo.define('wibicon_utility.ListWibiconView', function (require) {
"use strict";
 ...
 * form view. Only a ListWibiconRenderer is used in that case.
 */

var BasicView = require('web.BasicView');
var core = require('web.core');
var ListWibiconModel = require('wibicon_utility.ListWibiconModel');
var ListWibiconRenderer = require('wibicon_utility.ListWibiconRenderer');
var ListWibiconController = require('wibicon_utility.ListWibiconController');
const view_registry = require('web.view_registry');
var pyUtils = require('web.py_utils');

var _lt = core._lt;

var ListWibiconView = BasicView.extend({
    accesskey: "w",
    display_name: _lt('Wibicon List'),
    icon: 'fa-list-ul',
    config: _.extend({}, BasicView.prototype.config, {
        Model: ListWibiconModel,
        Renderer: ListWibiconRenderer,
        Controller: ListWibiconController,
    }),
    viewType: 'wibiconlist',
    /**
     * @override
     *
...
// return ListWibiconView;


view_registry.add('wibiconlist', ListWibiconView);
