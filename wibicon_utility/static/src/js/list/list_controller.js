odoo.define('wibicon_utility.ListWibiconController', function (require) {
"use strict";
...
var ListWibiconConfirmDialog = require('wibicon_utility.ListWibiconConfirmDialog');
...
var ListWibiconController = BasicController.extend({
    /**
    ...
    _saveMultipleRecords: function (recordId, node, changes) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (validRecordIds.length > 0) {
                ...
                new ListWibiconConfirmDialog(this, record, dialogChanges, dialogOptions)
